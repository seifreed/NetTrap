...
## JSON
Pretty-printed array of all events. Generated at shutdown.
...
All formats are generated at shutdown regardless of the primary format — SARIF and CSV are always produced.
