...
impl IrcBanner {
    pub fn get_banner(&self, server_name: &str) -> String {
        match self {
            IrcBanner::Generic => format!(":{}  NOTICE AUTH :*** Looking up your hostname...\r\n:{}  NOTICE AUTH :*** Found your hostname\r\n", server_name, server_name),
            IrcBanner::DebianIrcd => format!(":{}  NOTICE AUTH :*** Looking up your hostname...\r\n:{}  NOTICE AUTH :*** Checking Ident\r\n:{}  NOTICE AUTH :*** Found your hostname\r\n:{}  NOTICE AUTH :*** No Ident response\r\n", server_name, server_name, server_name, server_name),
...
impl Default for IrcBanner {
    fn default() -> Self { IrcBanner::Generic }
}
