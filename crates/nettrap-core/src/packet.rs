...
impl PacketDirection {
    ...
    pub fn is_outbound(&self) -> bool {
        matches!(self, PacketDirection::Outbound)
    }
}
...
impl PacketType {
    pub fn is_handshake(&self) -> bool {
        matches!(self, PacketType::Syn | PacketType::SynAck | PacketType::Ack)
    }

    pub fn is_teardown(&self) -> bool {
        matches!(self, PacketType::Fin | PacketType::FinAck | PacketType::Rst)
    }
}
