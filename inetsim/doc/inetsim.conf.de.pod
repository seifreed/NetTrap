...
=item I<include DATEINAME>

Binde weitere Datei in die Konfiguration ein.
Nur in der Haupt-Konfigurationsdatei erlaubt.
...
=item I<ftp(s)_post_limit ANZAHL>

Limitiert die maximale Groesse von POST-Requests auf die angegebene
Anzahl Bytes.
...
=item I<ftp(s)_max_filesize ANZAHL>
...
=item I<tftp_max_filesize ANZAHL>
